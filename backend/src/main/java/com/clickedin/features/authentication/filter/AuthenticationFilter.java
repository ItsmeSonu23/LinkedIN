package com.clickedin.features.authentication.filter;
...
public class AuthenticationFilter extends HttpFilter {
    private final List<String> unsecuredEndpoints = Arrays.asList("/api/v1/authentication/login",
            "/api/v1/authentication/register", "/api/v1/authentication/send-password-reset-token",
    ...
    protected void doFilter(HttpServletRequest request,HttpServletResponse response,FilterChain chain) throws IOException,ServletException{
        ...
        try {
            ...
            request.setAttribute("autheticatedUser", user);
            chain.doFilter(request, response);
